...
const Login = () => {
  ...
  return (
    <div className="container mx-auto py-10">
      <section className="max-w-sm p-6 m-auto mx-auto bg-white rounded-md shadow-md">
        <div className="container min-h-[450px] px-6 mx-auto">
          <form onSubmit={handleSubmit} className="w-full mt-14 max-w-md">
          ...
          <button
            ...
            className="px-6 flex w-full py-3 mt-4 duration-300 transform border-2 rounded-lg "
          >
